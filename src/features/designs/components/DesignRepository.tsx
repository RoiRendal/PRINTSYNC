      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between bg-white p-4 border border-gray-200 rounded shadow-sm dark:bg-zinc-900 dark:border-zinc-800">
        <div className="w-full md:max-w-md relative">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-100 bg-gray-50 text-sm focus:outline-none focus:border-blue-500 rounded transition-colors dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-200"
            value={searchTerm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="inline-block mt-2 px-2 py-1 bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-widest rounded dark:bg-blue-900/20 dark:text-blue-400">
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-zinc-800 flex gap-3">
                <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white text-[11px] font-bold uppercase tracking-wider hover:bg-blue-700 transition-colors rounded">
