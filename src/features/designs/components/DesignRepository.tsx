      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between bg-white p-4 border border-gray-200 rounded shadow-sm dark:bg-zinc-900 dark:border-zinc-800">
        <div className="w-full md:max-w-md relative">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-100 bg-gray-50 text-sm focus:outline-none focus:border-slate-700 rounded transition-colors dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-200"
            value={searchTerm}
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-[11px] font-bold uppercase tracking-wider rounded hover:bg-black shadow-sm whitespace-nowrap"
        >
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-1 items-start">
                    <button 
                      ...
                      className="p-1.5 text-gray-400 hover:text-slate-700 hover:bg-zinc-100 dark:hover:bg-zinc-800/30 rounded transition-colors"
                      title="Edit design"
                    >
        ...
        <form onSubmit={handleAddSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                type="text"
                className="flex-1 px-3 py-2 border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800 text-sm focus:outline-none focus:border-slate-700 transition-colors dark:text-zinc-200"
            ...
            <div className="flex flex-wrap gap-1 mt-2">
              {newDesign.tags.map(tag => (
                <span key={tag} className="px-2 py-1 bg-zinc-100 text-slate-900 text-[10px] font-medium rounded flex items-center gap-1 dark:bg-zinc-800/40 dark:text-zinc-200">
                  {tag}
                  <button type="button" onClick={() => removeTag(tag)} className="hover:text-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="inline-block mt-2 px-2 py-1 bg-zinc-100 text-slate-900 text-[10px] font-bold uppercase tracking-widest rounded dark:bg-zinc-800/40 dark:text-zinc-200">
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-zinc-800 flex gap-3">
                <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-slate-900 text-white text-[11px] font-bold uppercase tracking-wider hover:bg-black transition-colors rounded">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1 mt-2">
                {editDesignData.tags.map(tag => (
                  <span key={tag} className="px-2 py-1 bg-zinc-100 text-slate-900 text-[10px] font-medium rounded flex items-center gap-1 dark:bg-zinc-800/40 dark:text-zinc-200">
                    {tag}
                    <button type="button" onClick={() => removeEditTag(tag)} className="hover:text-slate-800">
                      <Plus className="w-3 h-3 rotate-45" />
                    </button>
                  </span>
                ))}
