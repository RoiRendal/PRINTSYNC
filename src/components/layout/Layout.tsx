...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex flex-col h-screen w-full overflow-hidden bg-gray-50 text-gray-900 font-sans selection:bg-blue-600 selection:text-white dark:bg-zinc-950 dark:text-zinc-100 transition-colors duration-300">
      {/* Global Top Header */}
      <header className="relative h-12 bg-white border-b border-gray-300 flex items-center justify-between px-6 shrink-0 dark:bg-zinc-900 dark:border-zinc-800 transition-colors duration-300 z-[60]">
      ...
      {/* New Header */}
      <div className="relative h-10 bg-gray-50 border-b border-gray-300 flex items-center px-4 shrink-0 dark:bg-zinc-950 dark:border-zinc-800 transition-colors duration-300 z-[40]">
        <button 
