              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-800/50 p-3 rounded border border-gray-100 dark:border-zinc-800 divide-y divide-gray-200 dark:divide-zinc-700">
                    ...
                    <div className="py-2 flex justify-between text-xs pt-2">
                      ...
                      <span className="font-bold text-blue-600 dark:text-blue-400">₱{selectedOrder.amount.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
                ...
                {selectedOrder.notes && (
                  <div className="space-y-2">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/10 p-3 rounded border border-blue-100 dark:border-blue-900/30 text-xs text-blue-800 dark:text-blue-300 italic">
                      "{selectedOrder.notes}"
                    </div>
                  </div>
                )}
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded text-[9px] font-bold uppercase tracking-wider transition-all border ${
                      selectedOrder.status === status
                        ...
                        : 'bg-white text-gray-600 border-gray-200 hover:border-blue-300 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-400'
                    }`}
                  >
                    {status}
                  </button>
