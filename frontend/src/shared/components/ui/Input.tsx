...
const fieldBaseClasses =
  'w-full rounded-[var(--radius-button)] border border-[var(--app-border-control)] bg-[var(--app-surface-raised)] px-3 text-sm text-macos-text shadow-inner shadow-black/[0.02] transition-all duration-200 ease-out placeholder:text-[var(--app-text-muted)] focus:border-[var(--app-border-control)] focus:bg-white focus:outline-none focus:ring-4 focus:ring-[var(--app-border-control)] dark:bg-[#414143] dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:bg-[#454547]';
