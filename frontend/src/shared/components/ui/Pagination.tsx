    ...
    <div className={cn('flex items-center justify-between gap-3', className)}>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className={cn(
            'flex h-7 w-7 items-center justify-center rounded-lg border border-[var(--app-hairline)] bg-[var(--app-surface-raised)] text-macos-text shadow-[var(--shadow-card)] transition-colors dark:text-zinc-200',
        ...
        {getVisiblePages().map((p, index) => (
          p === '...' ? (
            ...
            <button
              ...
              className={cn(
                'flex h-7 min-w-[1.75rem] items-center justify-center rounded-lg border px-1.5 text-[10px] font-bold uppercase tracking-wider shadow-[var(--shadow-card)] transition-colors',
                page === p
                  ? 'border-macos-blue/30 bg-macos-blue text-white dark:border-macos-blue-dark/25 dark:bg-macos-blue-dark'
                  : 'border-[var(--app-hairline)] bg-[var(--app-surface-raised)] text-macos-text hover:border-macos-blue/30 hover:bg-[var(--app-chrome)] dark:text-zinc-200 dark:hover:border-macos-blue-dark/25',
              )}
            >
              {p}
            </button>
