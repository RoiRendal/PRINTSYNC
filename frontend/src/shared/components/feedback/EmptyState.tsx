...
export function EmptyState({
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center gap-3 text-center text-macos-text-muted dark:text-zinc-500', className)}>
      <div className="flex h-16 w-16 items-center justify-center rounded-[1.35rem] border border-white/55 bg-white/62 text-macos-blue shadow-[var(--shadow-card)] dark:border-white/10 dark:bg-white/8 dark:text-macos-cyan">
        {icon}
      </div>
