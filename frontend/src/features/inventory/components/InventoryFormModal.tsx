        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)]">
          ...
          <div className="space-y-4">
            <label className="block space-y-1.5">
              <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">Material Name</span>
            ...
            <label className="block space-y-1.5">
              <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">Category</span>
             ...
             */}
            <label className="block space-y-1.5">
              <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">SKU <span className="font-normal normal-case">(optional)</span></span>
              <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="block space-y-1.5">
                <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">Current Stock</span>
                <Input required type="number" min="0" value={formData.stock} onChange={(e) => setFormData({ ...formData, stock: parseInt(e.target.value) || 0 })} />
              </label>
              <label className="block space-y-1.5">
                <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">Reorder Level</span>
            ...
            <label className="block space-y-1.5">
              <span className="text-2xs font-bold text-macos-text-muted dark:text-zinc-500">Unit Price (₱)</span>
