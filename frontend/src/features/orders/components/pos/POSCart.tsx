              ...
              <div className="flex gap-3">
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button type="button" onClick={() => onRemoveFromCart(idx)} className="mat-focus cursor-pointer rounded text-macos-text-muted transition-colors hover:text-red-700 dark:hover:text-red-300" aria-label={`Remove ${item.name}`}>
