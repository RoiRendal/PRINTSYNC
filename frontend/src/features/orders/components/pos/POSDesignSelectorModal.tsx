        ...
        <div className="grid max-h-[60vh] grid-cols-2 gap-3 overflow-y-auto pr-2 scrollbar-hide md:grid-cols-4 lg:grid-cols-5">
          {designs.map(design => (
            <button
              ...
              className="overflow-hidden rounded-[var(--radius-card)] border border-white/50 bg-white/72 text-left shadow-[var(--shadow-card)] backdrop-blur-xl transition-colors hover:border-macos-purple/45 dark:border-white/10 dark:bg-white/8"
            >
