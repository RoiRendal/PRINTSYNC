  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && filtered.length > 0 && (
        <div className="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-[var(--radius-card)] border border-white/45 bg-white/90 shadow-[var(--shadow-card)] dark:border-white/10 dark:bg-zinc-900/90">
      ...
      {isOpen && query && filtered.length === 0 && (
        <div className="absolute z-50 mt-1 w-full rounded-[var(--radius-card)] border border-white/45 bg-white/90 px-3 py-2 text-[11px] text-macos-text-muted shadow-[var(--shadow-card)] dark:border-white/10 dark:bg-zinc-900/90 dark:text-zinc-400">
