    ...
    <div className="space-y-5 pb-8">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-macos-text-muted">Live performance, margin telemetry, demand ranking, and forecasting in one glass dashboard.</p>
        </div>
        <GlassCard className="flex flex-col gap-2 p-3 md:flex-row md:items-center">
          <div className="flex items-center gap-2 px-1 text-[10px] font-bold uppercase tracking-[0.2em] text-macos-text-muted"><CalendarRange className="h-3.5 w-3.5" aria-hidden="true" /> Global Sort</div>
