    ...
    <GlassCard className="p-3">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="truncate text-[10px] font-bold uppercase tracking-[0.18em] text-macos-text-muted">{label}</p>
        ...
        {Icon && <Icon className="h-4 w-4 shrink-0 text-macos-text-muted" aria-hidden="true" />}
      </div>
    </GlassCard>
  );
}
